...
const NAV = [
  ...
  { section: "CÔNG CỤ" },
  { href: "/cong-cu/tu-dong-dien", label: "Tool 1: Tự Động Điền", icon: "⚡" },
  { href: "/cong-cu/thong-ke-gia", label: "Tool 2: Thống Kê Giá", icon: "📈" },
  { href: "/cong-cu/phan-loai-ai", label: "Tool 3: Phân Loại AI", icon: "🤖" },
  { href: "/cong-cu/khao-gia", label: "Tool 5: Khảo Giá", icon: "🔍" },
  { section: "QUẢN TRỊ" },
